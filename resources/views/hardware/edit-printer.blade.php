<x-app-layout>
    <x-slot name="header">
        <h2 class="font-medium text-lg text-slate-800 dark:text-white">
            {{ __('Home / Hardware Inventory / Printer & Copier / Edit Asset') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('hardware.printer.update', $asset->id) }}" method="POST" class="grid grid-cols-3 gap-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-span-3 flex gap-2">
                        ...
                        <a href="{{ route('hardware.printer') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">CANCEL</a>
                    </div>
                </form>
            </div>
        </div>
