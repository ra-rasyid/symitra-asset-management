    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6 border border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-bold dark:text-white mb-4 uppercase tracking-wider text-blue-600">Add New Asset</h3>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-bold dark:text-white uppercase tracking-wider">Notebook & PC List</h3>
                ...
                <div class="overflow-x-auto">
                    <table id="asset-table" class="w-full text-sm text-left border-collapse border border-gray-200 dark:border-gray-700">
                        ...
                        <tbody class="dark:text-gray-300">
                            ...
                            <tr class="{{ $key % 2 == 0 ? 'bg-gray-50 dark:bg-gray-700/50' : 'bg-white dark:bg-gray-800' }} hover:bg-blue-50 dark:hover:bg-gray-600 transition">
                                ...
                                <td class="p-3 border border-gray-200 dark:border-gray-700">
                                    <div class="flex justify-center items-center gap-3">
                                        ...
                                        <form action="{{ route('hardware.nb-pc.destroy', $asset->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus asset ini?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                            <tr>
                                <td colspan="11" class="p-6 text-center text-gray-500 italic">No assets found in the database.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
